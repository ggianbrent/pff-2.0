...
<html>
    <head>
		...
		<link rel="stylesheet" href="auth1.css">
    ...
    <body>
        ...
        <section class="section1">
            ...
            <div class="main_auth">
                <span id="auth_title2">Welcome back!</span>
                <span id="auth_title">Sign in</span>
                <div class="auth_box">
                    <form action="login_query.php" method="post" class="auth_form">
                        <input type="text" id="email_user" name="email" placeholder="Email" required>
                        <input type="password" id="password" name="password" placeholder="Password" required>
                        <!--<a href="#" id="f_pw"><span id="forgot_pw">Forgot password?</span></a>-->
                        <button type="submit" id="submit_signin" name="login">Sign In</button>
                    </form>
                    <div class="alt_container" style="display: none;">
                        <div id="line"></div>
                        <span id="line_text">or sign in with</span>
                    </div>
                    ...
                    <div class="no_acc">
                        <span>Not have an account? </span><a href="auth2.php"><span id="no_acc_bold">Sign up</span></a>
                    </div>
                </div>
            </div>
        </section>
