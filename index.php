        ...
        <div class="sidebar" id="sidebar" hidden>
            ...
            <div class="sidebar_menu">
                <ul class="sidebar_menu1">
                    <li><a href="home.php"><img src="./RESOURCES/images/icon_home.png" alt="home"><span>HOME</span></a></li>
                ...
                <ul class="sidebar_menu2">
                    ...
                    <?php endif; ?>
                    <li><a href="auth1.php"><img src="./RESOURCES/images/icon_acc.png"><span>LOGIN</span></a></li>
                </ul>
            </div>
        </div>
        <header class="navbar">
